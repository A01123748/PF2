...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let detVC = splitViewController.viewControllers[1] as! UINavigationController
        let mapsVC = detVC.topViewController as! MapsVC
        mapsVC.managedObjectContext = self.managedObjectContext
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let proxyBundle = Bundle(identifier: "com.fkts.QRMapas")
